...
%-------------------------------------------------------------
								\begin{figure}[h!]
								\centering
								\subfigure[3x2 RVQ codebook.  The reconstruction path taken through the codebook by the integer 8 is shaded dark.  Notice that monR is the only method unable to correctly decode the integer 8 and produces a 7 instead.  monR also incorrectly decodes 6, 8, 23 and 24.]{\includegraphics[width=0.5\textwidth]{thesis2/RVQ_CAC_toyExample_3x2.pdf}}
						\subfigure[3x2 TSVQ codebook and reconstruction path taken by the number 8.]{\includegraphics[width=0.85\textwidth]{thesis2/TSVQ_toyExample_3x2.pdf}}
								...
								\begin{table}[h]
								\centering
								\input{thesis2/aRVQ_4_6_8_10_20_22_24_26.tex}
...
%------------------------------------------------
								\begin{figure}[h]
								\centering
								\subfigure[8x2 RVQ codebook.  The reconstruction path taken through the codebook by the integer 13 is shaded dark.  Notice that monR is the only method unable to correctly decode the integer 13 and produces 16.5 instead.]{\includegraphics[height=3in]{thesis2/RVQ_CAC_toyExample_8x2.pdf}}\hspace{0.1in}
								\subfigure[For the 8x2 RVQ codebook, input and decoded outputs produced by monR.  Notice quite a few incorrect reconstructions.  In contrast, maxP, RofE and nulE all produce perfect reconstructions.]{\includegraphics[height=2in]{thesis2/RVQ_CAC_toyExample_8x2_monR.pdf}}
								\subtable{\input{thesis2/aRVQ_1_to_256.tex}}
								\subfigure{\includegraphics[width=0.5\textwidth]{thesis2/aRVQ_1_to_256.pdf}}
...
%------------------------------------------------
								...
								\begin{figure}[h]
								\centering
								\subtable{\begin{tiny}\input{thesis2/aRVQ_gaussian_rand.tex}\end{tiny}}
								\subfigure{\includegraphics[width=0.6\textwidth]{thesis2/aRVQ_gaussian_rand.pdf}}
...
%------------------------------------------------
								\begin{figure}[h]
								\centering
								\subtable{\begin{tiny}\input{thesis2/aRVQ_uniform_rand.tex}\end{tiny}}
								\subfigure{\includegraphics[width=0.6\textwidth]{thesis2/aRVQ_uniform_rand.pdf}}
...
%------------------------------------------------
								...
								\begin{figure}[h]
								\centering
								\subfigure[8x2.]{\fbox{\includegraphics[height=1.5in]{thesis2/Dudek_snippets_frames_1_to_100_8x2_RVQ.pdf}}}
								\subfigure[8x4.]{\fbox{\includegraphics[height=1.5in]{thesis2/Dudek_snippets_frames_1_to_100_8x4_RVQ.pdf}}}
								\subfigure[8x8.]{\fbox{\includegraphics[height=1.5in]{thesis2/Dudek_snippets_frames_1_to_100_8x8_RVQ.pdf}}}
								\subfigure[8x16.]{\fbox{\includegraphics[height=2.5in]{thesis2/Dudek_snippets_frames_1_to_100_8x16_RVQ.pdf}}}
								...
								\begin{figure}
								\centering
								\subtable{\begin{tiny}\input{thesis2/aRVQ_Dudek_first_100.tex}\end{tiny}}
								\subfigure{\includegraphics[width=0.6\textwidth]{thesis2/aRVQ_Dudek_first_100.pdf}}
...
%------------------------------------------------
								...
								\begin{figure}[h]
								\centering
								\subfigure[Training snippets.]{\includegraphics[width=0.55\textwidth]{thesis2/aRVQ_dudek_first_100rand_snippets.pdf}}
								\subfigure[Test snippet.]{\includegraphics[width=0.15\textwidth]{thesis2/dataset_Dudek_snippet_00101.png}}
								...
								\begin{figure}
								\centering
								\subtable{\begin{tiny}\input{thesis2/aRVQ_dudek_first_100rand_101test.tex}\end{tiny}}
								\subfigure{\includegraphics[width=0.6\textwidth]{thesis2/aRVQ_dudek_first_100rand_101test.pdf}}
...
Training snippets are similar to the ones in Figure~\ref{fig:aRVQ_dudek_first_100rand_snippets} since exactly the same noise parameters were used.
								...
								\begin{figure}[h]
								\centering
								\subtable{\begin{tiny}\input{thesis2/aRVQ_dudek_first_100rand_5test.tex}\end{tiny}}
								\subfigure{\includegraphics[width=0.6\textwidth]{thesis2/aRVQ_dudek_first_100rand_5test.pdf}}
								\caption{Reconstruction rms errors for different values of RVQ code-vectors per stage, $m$ with first 100 target snippets in the Dudek sequence randomized with zero-mean gaussian noise with 0.1 standard deviation.  The training snippets can be seen in Figure~\ref{fig:aRVQ_dudek_first_100rand_snippets}.}
								\label{fig:aRVQ_Dudek_first_100_rand}
								\end{figure}
