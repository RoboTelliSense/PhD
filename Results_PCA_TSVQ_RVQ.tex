...
\begin{figure}[h!]
\centering
\input{temp/results_maxP_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_maxP_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_maxP_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_maxP_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_maxP_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_RofE_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_RofE_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_RofE_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_RofE_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_RofE_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_nulE_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_nulE_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_nulE_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_nulE_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_nulE_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_monR_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_monR_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_monR_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_monR_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_monR_trk_2b.pdf}\label{fig:trk_pca_2b}}
