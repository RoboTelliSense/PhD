...
\begin{figure}[t]
\centering
\input{temp/results_final_1a_best}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_1a_best.pdf}\label{fig:results_final_1a_best}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_1a_best_percent.pdf}\label{fig:results_final_1a_best_percent}}
...
\begin{figure}[t]
\centering
\input{temp/results_final_1b_mean}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_1b_mean.pdf}\label{fig:results_final_1b_mean}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_1b_mean_percent.pdf}\label{fig:results_final_1b_mean_percent}}
...
\begin{figure}[t]
\centering
\input{temp/results_final_2a_16}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_2a_16.pdf}\label{fig:results_final_2a_16}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_2a_16_percent.pdf}\label{fig:results_final_2a_16_percent}}
...
\begin{figure}[t]
\centering
\input{temp/results_final_2b_32}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_2b_32.pdf}\label{fig:results_final_2b_32}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_2b_32_percent.pdf}\label{fig:results_final_2b_32_percent}}
...
\begin{figure}[h!]
\centering
\input{temp/results_final_pca__trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_pca__trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_pca__trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_pca__trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_pca__trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_final_tsvq_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_tsvq_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_tsvq_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_tsvq_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_tsvq_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_final_maxP_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_maxP_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_maxP_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_maxP_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_maxP_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_final_RofE_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_RofE_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_RofE_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_RofE_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_RofE_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_final_nulE_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_nulE_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_nulE_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_nulE_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_nulE_trk_2b.pdf}\label{fig:trk_pca_2b}}
...
\begin{figure}[h!]
\centering
\input{temp/results_final_monR_trk}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_monR_trk_1a.pdf}\label{fig:trk_pca_1a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_monR_trk_2a.pdf}\label{fig:trk_pca_2a}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_monR_trk_1b.pdf}\label{fig:trk_pca_1b}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{temp/results_final_monR_trk_2b.pdf}\label{fig:trk_pca_2b}}
