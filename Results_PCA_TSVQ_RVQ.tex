...
Overall, it appears that PCA and RVQ outperform TSVQ completely.  However, for the other metrics chosen, it appears that RVQ outperforms PCA in more areas.  In a tracking scenario, it is desirable to try different algorithms to get a feel for the dynamics of the underlying distribution.  Specifically, it is desired to understand how many DoFs are needed for a given algorithm to explain the distribution.  Our experiments show that for difficult distributions with several forms of noise, 8x4 RofE performs the best.
...
\begin{figure}[h!]
\centering
\subfigure[Tracking error over frames.]{\includegraphics[width=1.0\textwidth]{temp/out20.pdf}\label{fig:results_final_monR_a}}
\subfigure[Ground truth.]{\includegraphics[width=0.45\textwidth]{temp/out21.pdf}\label{fig:results_final_monR_b}}
\subfigure[P=3.]{\includegraphics[width=0.45\textwidth]{temp/out22.pdf}\label{fig:results_final_monR_c}}
\subfigure[P=4.]{\includegraphics[width=0.45\textwidth]{temp/out23.pdf}\label{fig:results_final_monR_d}}
\subfigure[P=5.]{\includegraphics[width=0.45\textwidth]{temp/out24.pdf}\label{fig:results_final_monR_d}}
\caption{Good tracking, frame=10.}
\label{fig:results_final_monR}
\end{figure}
...
\begin{figure}[h!]
\centering
\subfigure[Ground truth.]{\includegraphics[width=0.45\textwidth]{temp/out1.pdf}\label{fig:results_final_monR_b}}
\subfigure[P=3.]{\includegraphics[width=0.45\textwidth]{temp/out2.pdf}\label{fig:results_final_monR_c}}
\subfigure[P=4.]{\includegraphics[width=0.45\textwidth]{temp/out3.pdf}\label{fig:results_final_monR_d}}
\subfigure[P=5.]{\includegraphics[width=0.45\textwidth]{temp/out4.pdf}\label{fig:results_final_monR_d}}
\caption{P=4 has greatest error in this frame, frame 457.}
\label{fig:results_final_monR}
\end{figure}
