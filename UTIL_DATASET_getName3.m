function [ds_2_name, ds_3_name] =    UTIL_DATASET_getName3(ds_1_code)
    ...
    elseif  (ds_1_code==3)  ds_2_name = 'sylv';          ds_3_name='3_sylv___';
    elseif  (ds_1_code==4)  ds_2_name = 'trellis70';     ds_3_name='4_trelis_';
    elseif  (ds_1_code==5)  ds_2_name = 'fish';          ds_3_name='5_fish___';
    elseif  (ds_1_code==6)  ds_2_name = 'car4';          ds_3_name='6_car4___';
    elseif  (ds_1_code==7)  ds_2_name = 'car11';         ds_3_name='7_car11__';
