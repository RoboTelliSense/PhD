...
elseif  (datasetCode==3) INP.ds_2_name = 'sylv';          INP.ds_3_longName='3___sylv___________';  F=620;
elseif  (datasetCode==4) INP.ds_2_name = 'trellis70';     INP.ds_3_longName='4___trellis70______';  F=501;
elseif  (datasetCode==5) INP.ds_2_name = 'fish';          INP.ds_3_longName='5___fish__________';   F=476;
elseif  (datasetCode==6) INP.ds_2_name = 'car4';          INP.ds_3_longName='6___car4___________';  F=659;
elseif  (datasetCode==7) INP.ds_2_name = 'car11';         INP.ds_3_longName='7___car11__________';  F=393;
