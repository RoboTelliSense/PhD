...
elseif  (datasetCode==3) PARAM.ds_2_name = 'sylv';          PARAM.ds_3_name2='3___sylv___________';  F=620;
elseif  (datasetCode==4) PARAM.ds_2_name = 'trellis70';     PARAM.ds_3_name2='4___trellis70______';  F=501;
elseif  (datasetCode==5) PARAM.ds_2_name = 'fish';          PARAM.ds_3_name2='5___fish__________';   F=476;
elseif  (datasetCode==6) PARAM.ds_2_name = 'car4';          PARAM.ds_3_name2='6___car4___________';  F=659;
elseif  (datasetCode==7) PARAM.ds_2_name = 'car11';         PARAM.ds_3_name2='7___car11__________';  F=393;
