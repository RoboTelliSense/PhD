...
%------------------------------------------------
    ...
    Table_pca               = [ OUT.pca__1_Dudek__ ...
                                OUT.pca__2_david__ ...
                                OUT.pca__3_sylv___ ...
                                OUT.pca__5_fish___ ...
                                OUT.pca__6_car4___ ...
                                OUT.pca__7_car11__ ];
    temp                    =   mean(Table_pca, 2);
    Table_pca               =   [Table_pca temp];
...
%PCA
    figure;
    plot(Table_pca(1,:), 'r*-'); hold on; %8
    plot(Table_pca(2,:), 'gs-');          %16
    plot(Table_pca(3,:), 'bd-');          %32
    legend({'8', '16', '32'});
    grid on;
    axis([1 7 0 15])
    ...
    UTIL_FILE_save2pdf('temp/Table_pca.pdf', gcf, 300);
