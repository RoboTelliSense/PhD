...
%                 %likelihood
        ...
        %-----------------------------------------------------------------
                if (bSave)                
                    ...
                    %saveas(h, [odir 'trkRVQx_PETS2001_' UTIL_GetZeroPrefixedFileNumber(f_idx) '.jpg']) ; 

                    %print('-djpeg', '-r300', [odir 'trkRVQx_PETS2001_' UTIL_GetZeroPrefixedFileNumber(f_idx) '.jpg']) ; 
