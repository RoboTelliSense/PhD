...
%                 %likelihood
        ...
        %-----------------------------------------------------------------
                if (bSave)                
                    ...
                    %saveas(h, [odir 'trkRVQE_PETS2001_' UTIL_GetZeroPrefixedFileNumber(f_idx) '.jpg']) ; 

                    %print('-djpeg', '-r300', [odir 'trkRVQE_PETS2001_' UTIL_GetZeroPrefixedFileNumber(f_idx) '.jpg']) ; 
