%if (Ntrg_snp             >=  PARAM.trg_B)
    ...
    if (bUseBPCA )               TRK_draw_3a_metrics_trg( trkBPCA.trg_4_SNRdB, trkBPCA.trg_5_rmse, trkBPCA.trgout_avgrmse, f, PARAM.trg_frame_idxs,   PARAM.plot_title_fontsz, 2);        end
