%if (Ntrg_snp             >=  PARAM.trg_freq)
                                TRK_draw_3a_metrics_trg( trkIPCA.trg_SNRdB_Tx1, trkIPCA.trg_rmse__Tx1, trkIPCA.trg_armse_Tx1, f, PARAM.trg_frame_idxs,   PARAM.plot_title_fontsz, 1);        
	...
	if (bUseRVQE)                TRK_draw_3a_metrics_trg( rvq__trg_SNRdB, rvq__trg_rmse, rvq__trgout_avgrmse, f, PARAM.trg_frame_idxs,   PARAM.plot_title_fontsz, 3);        end 
%end



                                TRK_draw_3b_metrics_tst( trkIPCA.tst_SNRdB_Fx1, trkIPCA.trk_rmse__Fx1, trkIPCA.trk_armse_Fx1, f,          PARAM.plot_title_fontsz, 1);
	...
	if (bUseRVQE)                TRK_draw_3b_metrics_tst( rvq__tst_SNRdB, rvq__tst_rmse, rvq__tst_avgrmse, f,          PARAM.plot_title_fontsz, 3);        end      
