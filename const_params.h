...
extern int gopen(char*,enum rw_perm);
extern int gread(int,byte*,enum data_types,enum data_types,int,enum yin_yang);
extern int gwrite(int,byte*,enum data_types,enum data_types,unsigned,enum yin_yang);
extern long gsizeof(char*);
extern long gseek(int,long,int);


#endif /* __INCconst_paramsh */