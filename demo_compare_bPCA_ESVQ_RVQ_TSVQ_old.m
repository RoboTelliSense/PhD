...
% 
% aRVQE.trg_1_featr_QxN: training XDRs from using gen.exe -l or my Matlab software
%
...
% aRVQE.in_3__maxQ   =   8
% aRVQE.in_4__M___      =   2
% Then aRVQE.mdl_3_CB_DxMQ (the red channel of the codebooks) is 
%       m=1   m=2
%       ---   ---
% p=1  192.5  64.5
% p=2  -32    32
...
% The first M=2 numbers in aRVQE.mdl_3_CB_DxMQ are the scalar codevectors for stage 1,
...
%training    
    ...
    aRVQE                   =   RVQ__1_learn     (DM2, aRVQE);           
    aTSVQ                   =   TSVQ_1_learn     (DM2, aTSVQ); 
    
%testing
   
    aBPCA                   =   PCA__2_encode   (DM2, aBPCA);                  
    aRVQE                   =   RVQ__2_encode   (DM2, aRVQE);
...
%view
    ...
    numDisplayCols          =   10;
                                ...
                                figure;DM2_show(aRVQE.mdl_3_CB_DxMQ, sh, sw, aRVQE.mdl_1_Q__1x1, aRVQE.in_4__M___, 1);title('aRVQE codebooks');
