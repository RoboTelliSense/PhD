...
if (bUseRVQ)    rvq__fig_DM = figure(12);     DATAMATRIX_display_DM2_as_image(RVQ.DM2, sh, sw, 10, 10);    end
...
if (bUseRVQ)    rvq__fig_DM_new = figure(22);     DATAMATRIX_display_DM2_as_image(RVQ.DM2_weighted, sh, sw, 10, 10);    end
