%> @file TRK_subspace_wrapper.m
%> @brief Loads data and initializes variables
%>
...
%> -----------------------
%> Np                       :   The number of samples used in the condensation algorithm/particle
%> condenssig               :   The standard deviation of the observation likelihood.
%>
%> incremental PCA
%> ---------------
%> ff                       :   forgetting factor.  When doing the incremental update, 
%>                              1 means remember all past data, and 0 means remeber none of it.
%>
%> overall options
%> ---------------
...
%snippet size: should i change 32 to 33? !!
