function hh=TRK_draw_1_I(f, data, CONFIG, trkIPCA, trkBPCA, trkRVQ, trkTSVQ, ...
            ...
            if (PARAM.in_bUseBPCA  || PARAM.in_bUseRVQ || PARAM.in_bUseTSVQ)
                ...
                I               =   uint8(data(:,:,f));
                                    ...
                                    title(PARAM.str_f);
                                    hold on
                                    UTIL_drawQuadFrom6affine_1x6(PARAM.sz, trkIPCA.tgt_best_affROI_1x6, 'Color','r', 'LineWidth',1.0);            
            ...
            if (PARAM.in_bUseBPCA )
                if (exist('trkBPCA.FP_1_gt'))
                      ...
                      UTIL_drawQuadFrom6affine_1x6(PARAM.sz, trkBPCA.tgt_best_affROI_1x6, 'Color','m', 'LineWidth',1.0);
                end
            end 
            ...
            if (PARAM.in_bUseTSVQ)
                if (exist('trkTSVQ.FP_1_gt'))
                      ...
                      UTIL_drawQuadFrom6affine_1x6(PARAM.sz, trkTSVQ.tgt_best_affROI_1x6, 'Color','b', 'LineWidth',1.0);
                end
            end 
            ...
            if (PARAM.in_bUseRVQ)
                if (exist('trkRVQ.FP_1_gt'))
                    ...
                    UTIL_drawQuadFrom6affine_1x6(PARAM.sz, trkRVQ.tgt_best_affROI_1x6, 'Color','g', 'LineWidth',1.0);                                            
                end
            end
