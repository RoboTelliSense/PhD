	...
	if (Ntrg_snp             >=  PARAM.trg_B) %i.e.train every batchsize images
        ...
        clear struct1;
                        struct1.data(1) = trkIPCA.tst_4_SNRdB_1x1;      struct1.data(2) =  trkIPCA.tst_5_rmse__1x1;     struct1.data(3) = trkIPCA.tst_RMSEavg_Fx1(f);        UTIL_savecsv_struct(trkIPCA.cfn_5_tst_rmse,       f, struct1);
