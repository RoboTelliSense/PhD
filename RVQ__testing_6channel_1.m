function RVQ = RVQ__2_encode_decode_6D(tst_Dx1, RVQ)
	...
	%go over all stages
        for t=1:T    
			...
			best_CB 					=	[mdl_3_EC_DxMQ(:,best_idx);mdl_CBg_DxMP(:,best_idx);mdl_CBb_DxMP(:,best_idx);CBn_r(:,best_idx);CBn_g(:,best_idx);CBn_b(:,best_idx)];
            ...
            %temp_snr_dB				=   UTIL_METRICS_compute_SNRdB  (tst_6Dx1, temp_err_6Dx1);                        
