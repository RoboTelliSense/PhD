...
%1. Dudek                       %    maxQ   RofE   nulE   monR
	OUT.rvq__1_Dudek___old   =	[    -1     6.68   7.96   7.85  ; 	%8x2
...
%2. davidin300                  %    maxQ   RofE   nulE   monR
	OUT.rvq__2_david___old  =   [  	 5.67   6.93   8.72  11.31;  %8x2
...
%3. sylv                        %    maxQ   RofE   nulE   monR
	OUT.rvq__3_sylv____old  = 	[	 4.26   4.29   4.72   5.61;  %8x2
...
%5. fish                        %    maxQ   RofE   nulE   monR
	OUT.rvq__5_fish____old  = 	[	 2.73   3.82   3.93   3.32; %8x2
...
%6. car4                        %    maxQ   RofE   nulE   monR
    OUT.rvq__6_car4____old  =   [    5.08   4.86   5.18   5.93; %8x2
 ...
 %7. car11                      %    maxQ   RofE   nulE   monR
    OUT.rvq__7_car11___old  =   [    2.32   2.23   2.57   2.23; %8x2
                                     2.30   2.06   2.12   2.71; %8x4
                                     2.14   2.48   3.45  12.04; %8x8
                                     2.94   2.90   5.29   -1;   %8x12
                                     -1     2.78   2.97   2  ]; %8x16
%----------------------------------------------------
% RVQ (using encoder + decoder codebook)
%----------------------------------------------------
%1. Dudek                       %    maxQ   RofE   nulE   monR
	OUT.rvq__1_Dudek__      =	[    7.78   7.11   9.65  11.81; %8x2
...
%2. davidin300                  %    maxQ   RofE   nulE   monR                               
    OUT.rvq__2_david__     =   [     6.84   9.02   7.17   -1;   %8x2
                                     4.47   6.21   5.35   5.83; %8x4
                                     9.89   5.74   4.63   4.15; %8x8
                                     7.16   6.67   6.42   5.25; %8x12
                                     7.23   7.31   -1     5.58];%8x16
                                 
%3. sylv                        %    maxQ   RofE   nulE   monR                                
    OUT.rvq__3_sylv___      =   [    4      4.12   4.81   4.31; %8x2
...
%5. fish                        %    maxQ   RofE   nulE   monR                                
    OUT.rvq__5_fish___      =   [   11.50   2.96   4.03   2.89; %8x2
...
%6. car4                        %    maxQ   RofE   nulE   monR                                 
    OUT.rvq__6_car4___      =   [    4.67   4.93   5.28   5.07; %8x2
...
%7. car11                       %    maxQ   RofE   nulE   monR                                
    OUT.rvq__7_car11__      =   [    2.32   2.47   2.59   2.47; %8x2
...
%----------------------------------------------------
    ...
    OUT.pca__2_david__      =   [    8.36 ; 4.60 ; 6.93    ]; %8, 16, 32
    OUT.pca__3_sylv___      =   [    4.34 ; 5.47 ; 5.72    ]; %8, 16, 32
    OUT.pca__5_fish___      =   [    9.75 ; 2.17 ; 7.98    ]; %8, 16, 32
    OUT.pca__6_car4___      =   [    4.79 ; 4.60 ; 5.52    ]; %8, 16, 32
    OUT.pca__7_car11__      =   [    2.21 ; 2.13 ; 2.39    ]; %8, 16, 32
...
%----------------------------------------------------
    ...
    OUT.tsvq_2_david__      =   [   12.88 ; 6.29 ; 5.93   ]; %3, 4, 5
    OUT.tsvq_3_sylv___      =   [    4.70 ; 4.80 ; 4.61   ]; %3, 4, 5       
    OUT.tsvq_5_fish___      =   [   10.07 ; 4.59 ; 5.47   ]; %3, 4, 5
    OUT.tsvq_6_car4___      =   [    5.11 ; 6.79 ; 5.80   ]; %3, 4, 5
    OUT.tsvq_7_car11__      =   [    2.21 ; 5.28 ; 2.94   ]; %3, 4, 5