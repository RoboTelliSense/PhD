...
elseif  (datasetCode==3) CONFIG.datasetName = 'sylv';          CONFIG.fullDatasetName='3___sylv___________';  F=379;%using instead of 620 just for RVQ_16x..
elseif  (datasetCode==4) CONFIG.datasetName = 'trellis70';     CONFIG.fullDatasetName='4___trellis70______';  F=434;%same reason as above, should be 501;
elseif  (datasetCode==5) CONFIG.datasetName = 'fish';          CONFIG.fullDatasetName='5___fish__________';   F=476;
elseif  (datasetCode==6) CONFIG.datasetName = 'car4';          CONFIG.fullDatasetName='6___car4___________';  F=589;%same reason as above, should be 657;
elseif  (datasetCode==7) CONFIG.datasetName = 'car11';         CONFIG.fullDatasetName='7___car11__________';  F=306;
