...
elseif  (datasetCode==3) datasetName = 'sylv';          fullDatasetName='3___sylv___________';  F=379;%using instead of 620 just for RVQ_16x..
elseif  (datasetCode==4) datasetName = 'trellis70';     fullDatasetName='4___trellis70______';  F=434;%same reason as above, should be 501;
elseif  (datasetCode==5) datasetName = 'fish';          fullDatasetName='5___fish__________';   F=476;
elseif  (datasetCode==6) datasetName = 'car4';          fullDatasetName='6___car4___________';  F=589;%same reason as above, should be 657;
elseif  (datasetCode==7) datasetName = 'car11';         fullDatasetName='7___car11__________';  F=306;
