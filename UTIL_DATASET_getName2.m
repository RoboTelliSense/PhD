...
elseif  (datasetCode==3) PARAM.ds_2_name = 'sylv';          PARAM.ds_3_longName='3___sylv___________';  F=379;%using instead of 620 just for RVQ_16x..
elseif  (datasetCode==4) PARAM.ds_2_name = 'trellis70';     PARAM.ds_3_longName='4___trellis70______';  F=434;%same reason as above, should be 501;
elseif  (datasetCode==5) PARAM.ds_2_name = 'fish';          PARAM.ds_3_longName='5___fish__________';   F=476;
elseif  (datasetCode==6) PARAM.ds_2_name = 'car4';          PARAM.ds_3_longName='6___car4___________';  F=589;%same reason as above, should be 657;
elseif  (datasetCode==7) PARAM.ds_2_name = 'car11';         PARAM.ds_3_longName='7___car11__________';  F=306;
