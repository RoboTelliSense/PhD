...
%------------------------------------
								...
								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.38\textheight]{figs/1_David_8_4_1000_trk_rmse.pdf}
								\caption{8x4 RVQ, tracking error (rmse).}
								\label{fig:1_David_8_4_1000_trk_rmse}
								\end{figure}


								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.38\textheight]{figs/1_David_8_4_1000_trk_armse.pdf}
								\caption{8x4 RVQ, tracking error (average rmse).}
								\label{fig:1_David_8_4_1000_trk_avg_rmse}
								\end{figure}
...
%------------------------------------
								...
								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_snp_SNRdB.pdf}
								\caption{8x4 RVQ, snippet reconstruction SNR in dB.}
								\label{fig:1_David_8_4_1000_snp_SNRdB}
								\end{figure}

								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_snp_rmse.pdf}
								\caption{8x4 RVQ, snippet reconstruction error (rmse).}
								\label{fig:1_David_8_4_1000_snp_rmse}
								\end{figure}


								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_snp_armse.pdf}
								\caption{8x4 RVQ, snippet reconstruction error (avg. rmse).}
								\label{fig:1_David_8_4_1000_snp_armse}
								\end{figure}
...
%------------------------------------
								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_trg_SNRdB.pdf}
								\caption{8x4 RVQ, training SNR in dB.}
								\label{fig:1_David_8_4_1000_trg_SNRdB}
								\end{figure}

								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_trg_rmse.pdf}
								\caption{8x4 RVQ, training error (rmse).}
								\label{fig:1_David_8_4_1000_trg_rmse}
								\end{figure}


								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_trg_armse.pdf}
								\caption{8x4 RVQ, training error (avg. rmse).}
								\label{fig:1_David_8_4_1000_trg_armse}
								\end{figure}
...
%------------------------------------
								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_tst_SNRdB.pdf}
								\caption{8x4 RVQ,testing SNR in dB.}
								\label{fig:1_David_8_4_1000_tst_SNRdB}
								\end{figure}

								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_tst_rmse.pdf}
								\caption{8x4 RVQ, testing error (rmse).}
								\label{fig:1_David_8_4_1000_tst_rmse}
								\end{figure}


								\begin{figure}[h!]
								\centering
								\includegraphics[height=0.4\textheight]{figs/1_David_8_4_1000_tst_armse.pdf}
								\caption{8x4 RVQ, testing error (avg. rmse).}
								\label{fig:1_David_8_4_1000_tst_armse}
								\end{figure}
