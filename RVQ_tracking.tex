...
In this experiment, we train an 8x2, 8x4 and 8x8 RVQ codebook on 100 realizations of a unit-variance Gaussian random variable in $\mathbb{R}^{1089}$.  Decoding is then done on a different 100 realizations of a unit-variance Gaussian random variable in $\mathbb{R}^{1089}$.  This experiment is repeated 10 times and the results are averaged and displayed in Table~\ref{table:results}.  This experiment is then repeated for a uniform random variable.
								...
								\caption{Training snippets, first 100 frames of Dudek sequence.}
								...
								\centering
								\includegraphics[width=0.55\textwidth]{figs/Dudek_snippets_frames_1_to_100.pdf}
								\caption{Training snippets extracted from the first 100 frames of Dudek sequence.}
								\label{fig:Dudek_1_to_100}
								\end{figure}
...
In this experiment, we use the approach of extracting snippets from feature points.  However, in this case, we have ground truth feature points.  Extracted snippets are shown in Figure~\ref{fig:Dudek_1_to_100}.  Training and test rms errors for this experiment are given in Table~\ref{table:results}.  Codebooks are given in Figure~\ref{fig:RVQ_Dudek_codebook}.  As opposed to the experiments with random data, we see some trends here.  As expected, the training and rms errors decrease with increasing code-vectors per stage.  However, in going from $M=8$ to $M=16$, the error increases again, probably due to the increasing difficulty of satisfying the CAC condition.
...
$S_{\textrm{trg}}=\{4, 6, 8, 10, 20, 22, 24, 26\}$ \newline $S_{\textrm{tst}}=S_{\textrm{trg}}$ 
                                                &8x2							&0								&{\color{red}0}	&{\color{red}0}		&{\color{red}0} 		&0.7071\\\hline
same                                         &8x4							&0								&{\color{red}0}	&{\color{red}0}		&{\color{red}0} 		&0\\\hline
same                                         &8x8							&0								&{\color{red}0}	&{\color{red}0}		&{\color{red}0} 		&0\\\hline\hline
S=$\{1, 2, \ldots, 256\}$  \newline $S_{\textrm{tst}}=S_{\textrm{trg}}$  				
												&8x2							&0                     		&{\color{red}0}	&{\color{red}0}		&0		&5.2723\\\hline
same                                         &8x4							&0								&{\color{red}0}	&{\color{red}0}		&0.0726 &0.8745\\\hline
same                                         &8x8							&0								&{\color{red}0}	&{\color{red}0}		&0.0090 					&0.2700\\\hline\hline
...
same as above							&8x4							&0.2930						&0.3485   	 		&0.3482    				&{\color{red}0.3052}    					&{\color{red}0.3052}\\\hline
same as above							&8x8							&0.3294						&0.3989   	 		&0.3987    				&{\color{red}0.3190}    &{\color{red}0.3190}\\\hline\hline
$S_{\textrm{trg}}$ = first 100 images of Dudek sequence, $S_{\textrm{tst}}=S_{\textrm{trg}}$ 
											&8x2 								&5.4020   	 				&5.4020 			&5.4020    				&{\color{red}5.3649}    &6.1394 \\\hline
same as above						&8x4 								&3.8015    					&3.8015    			&3.8015 				&{\color{red}3.7566}    &4.6929	\\\hline				same as above						&8x8 					    		&2.4572				   		&{\color{red}2.4572} 	&{\color{red}2.4572}   &2.4867    		&3.8344\\\hline
same as above 						&8x16 							&5.0669    					&5.0669 			&5.0669    				&{\color{red}4.6346}    &5.0828\\\hline
\end{tabular}
