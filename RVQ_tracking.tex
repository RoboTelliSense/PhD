...
%================================
								\begin{figure}
								\centering
								\subtable{\input{tables/aRVQ_4_6_8_10_20_22_24_26.tex}}
								\subfigure{\includegraphics[width=0.6\textwidth]{figs/aRVQ_4_6_8_10_20_22_24_26.pdf}}
								...
								\subfigure{\includegraphics[width=0.6\textwidth]{figs/aRVQ_1_to_256.pdf}}
								\caption{Reconstruction rms errors for different values of RVQ code-vectors per stage, $m$.  The training set $S_{\textrm{trg}}$ consists of the scalars $\{1, 2, \ldots 256\}$.  The test set $S_{\textrm{tst}}$ is the same as the training set.}
								...
								\begin{figure}
								\centering
								\subtable{\input{tables/aRVQ_gaussian_rand.tex}}
								...
								\begin{figure}
								\centering
								\subtable{\input{tables/aRVQ_uniform_rand.tex}}
								...
								\begin{figure}
								\centering
								\subtable{\input{tables/aRVQ_Dudek_first_100.tex}}
