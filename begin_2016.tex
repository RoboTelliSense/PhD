...
%logo evolution
	...
	\begin{textblock}{1}(110,1) %(117,85)  for bottom
    		\includegraphics[width=0.65in]{thesis/logo_evolution.pdf}
    	\end{textblock} 
    }
...
%logo Qualcomm
    \newcommand{\logoQualcomm}
    {
    	\begin{textblock}{1}(110,2) %(100,85)  for bottom
    		\includegraphics[width=1.5cm]{thesis/logo_qualcomm.jpg}
    	\end{textblock}
    }
%logo Qualcomm (long)
    \newcommand{\logoQualcommllong}
    {
    	\begin{textblock}{1}(0,0) 
    		\includegraphics[width=1.25in]{thesis/logo_qualcomm_long.jpg}
    	\end{textblock}
    }
...
%logo tree
    ...
    {
    	\begin{textblock}{1}(0,0) 
    		\includegraphics[width=1.25in]{thesis/logo_tree.jpg}
    	\end{textblock}
    }
%page numbers
    \newcommand{\mypagenum}
...
%personal details
	\author{Salman Aslam}
	\institute{Visiting Research Fellow\\Lahore University of Management Sciences}
	\date{}
