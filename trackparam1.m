...
%
% 'con_normalizer',0.01,  The standard deviation of the observation likelihood.
%
...
case 'dudek';  p = [188,192,110,130,-0.08];
    opt = struct('numsample',600, 'con_normalizer',0.25, 'ff',1, ...
...
%   opt = struct('numsample',4000, 'con_normalizer',1, 'ff',1, ...
...
if (~exist('datatitle') | ~strcmp(title,datatitle))
  ...
  disp(['loading ' title '...']);
  clear GT;
  load([title '.mat'],'data','datatitle','GT');
end
