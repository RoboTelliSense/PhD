function hout=suptitle(str, CONST.plot_title_fontsz)
...
if nargin < 2
  CONST.plot_title_fontsz = get(gcf,'defaultaxesfontsize')+4;
end
...
% + xlabel) and bounding rectangle.
	...
	ff = (CONST.plot_title_fontsz-4)*1.27*5/pos(4)*fudge;
...
%set(ht,'horizontalalignment','center','fontsize',CONST.plot_title_fontsz);
set(ht,'fontsize',CONST.plot_title_fontsz);
set(gcf,'nextplot',np);
axes(haold);
if nargout,
	hout=ht;
