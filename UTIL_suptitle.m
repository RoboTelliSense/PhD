function hout=suptitle(str, PARAM.plot_title_fontsz)
...
if nargin < 2
  PARAM.plot_title_fontsz = get(gcf,'defaultaxesfontsize')+4;
end
...
% + xlabel) and bounding rectangle.
	...
	ff = (PARAM.plot_title_fontsz-4)*1.27*5/pos(4)*fudge;
...
%set(ht,'horizontalalignment','center','fontsize',PARAM.plot_title_fontsz);
set(ht,'fontsize',PARAM.plot_title_fontsz);
set(gcf,'nextplot',np);
axes(haold);
if nargout,
	hout=ht;
