...
\begin{figure}[htp]			
	\includegraphics[width=1\textwidth]{figs/Quantization_blockDiagram.pdf}
...
\begin{figure}[t]		
	\center	
	\includegraphics[height=0.4\textheight]{figs/MPEG4_VTK.png}
...
\begin{figure}[ht]
	...
	\subfigure[]
	{
		\includegraphics[width=0.65\textwidth]{figs/RVQ_graphicalReconstruction.pdf}
		\label{fig:MTT_codebooks}	
	}
	\subfigure[]
	{
		\includegraphics[width=0.65\textwidth]{figs/RVQ_trellis.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[height=0.6\textheight]{figs/RVQ_encoder_flowDiagram.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[height=0.6\textheight]{figs/RVQ_explorer_flowDiagram.pdf}
