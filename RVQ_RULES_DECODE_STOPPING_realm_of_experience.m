...
%> ======================================================================
%> 
%> tst_XDR_parPx1: normally, you would have tst_1_descriptor_Px1, the P showing full
...
function continue_decoding = RVQ_RULES_DECODE_STOPPING_realm_of_experience(descriptors_PxN, tst_XDR_parPx1)
