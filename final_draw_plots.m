...
for datasetCode=1:1
    [INP.ds_2_name, INP.ds_3_longName] = dataset_getName(datasetCode);
    ...
    for Nw = 2;%[2 4 8 16 32 64 128 10000]
        ...
        for w=0
            ...
            for c=1:size(config, 1)
                ...
                tsvq_T          =   config(c,5);
                j               =   j+1
                [dir_out_wo_slash dir_out]         =   UTIL_DATASET_makeName(INP.ds_3_longName, bUseBPCA , bUseRVQ, bUseTSVQ, Np, Nw, w, ipca_Neig, bpca_Neig, rvq_maxT, rvq_S, rvq_targetSNR, tsvq_T);
