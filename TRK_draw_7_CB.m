if (Ntrg_snp             >=  CONFIG.trg_B)
    ...
    if (bUseBPCA )   bpca_fig_CB = figure(31);     DATAMATRIX_display_DM2_as_image(BPCA.mdl_U_DxN,       sh, sw, 8, 8);      UTIL_saveimg_wholeFigure(bpca_fig_CB, [dir_out 'CB_bpca_' str_f '.png']);end
    if (bUseRVQ)    rvq__fig_CB = figure(32);     DATAMATRIX_display_DM2_as_image(RVQ.mdl_CBr_DxMP,              sh, sw, 8, 8);      UTIL_saveimg_wholeFigure(rvq__fig_CB, [dir_out 'CB_rvq__' str_f '.png']);end
