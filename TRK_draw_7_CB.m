if (Ntrg_snp             >=  PARAM.trg_freq)
    ...
    if (bUseRVQx)    rvq__fig_CB = figure(32);     DATAMATRIX_display_DM2_as_image(RVQ.mdl_3_CB_DxMP,              sh, sw, 8, 8);      UTIL_saveimg_wholeFigure(rvq__fig_CB, [odir 'CB_rvq__' str_f '.png']);end
