%UTIL_FILE_save2pdf Saves a figure as a properly cropped pdf
%
%   UTIL_FILE_save2pdf(pdfFileName,handle,dpi)
%
...
function UTIL_FILE_save2pdf(pdfFileName,handle,dpi)
