...
%-----------------------------------
        ...
        candErrs_featr_QxNp =   U_DxQ' * cand_snps_zc_0t1_shxswxNp;                 %1. projections
        candErrs_recon_DxNp =   U_DxQ  * candErrs_featr_QxNp;               %2. reconstructions (mean removed though)
